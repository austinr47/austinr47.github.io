      ...
      <div className="home-main">
        ...
        <div className='home-right'>
          ...
          <div className='menu-sections'>
            <a onClick={() => scrollToComponent(this.About, { offset: 0, align: 'top', duration: 500})} className='menu-about'>About</a>
            <a onClick={() => scrollToComponent(this.Skills, { offset: 0, align: 'top', duration: 500})} className='menu-skills'>Skills</a>
            <a onClick={() => scrollToComponent(this.Projects, { offset: 0, align: 'top', duration: 500})} className='menu-projects'>Projects</a>
            <a onClick={() => scrollToComponent(this.Contact, { offset: 0, align: 'top', duration: 500})} className='menu-contact'>Contact</a>
          </div>
        </div>
      </div>
    );
